...
_min_version = '0.4.1'  # Minimum required package version for the plugin.
_version_next = '0.5.0'  # Next package version which may no longer be compatible with this version of the plugin.
