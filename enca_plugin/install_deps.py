...
_min_version = '0.7.0'  # Minimum required package version for the plugin.
_version_next = '0.8.0'  # Next package version which may no longer be compatible with this version of the plugin.
